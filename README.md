...
- Si se reinicia el entorno de ejecución (o Colab lo reinicia solo por inactividad), hay que correr todo de nuevo con **Entorno de ejecución → Reiniciar y ejecutar todas** -- correr celdas sueltas fuera de orden falla porque las dependencias ya no están instaladas.
